...
// BUILTIN_DOMAINS extracted to apiDomainWhitelistData.ts (leaf module) to break
// db-core.ts → db-plugin.ts → apiDomainWhitelist.ts → db.ts → db-core.ts cycle (#10).
// Re-exported here for backward compatibility; FALLBACK_DOMAINS derives from it below.
export { BUILTIN_DOMAINS } from './apiDomainWhitelistData.js';
import { BUILTIN_DOMAINS } from './apiDomainWhitelistData.js';
