 ...
 *
 * 实现已提取到 engine/error-handling/chat-error-classifier.ts（leaf 模块），
 * 此处导入并重新导出以保持向后兼容。
 */
import { classifyAndFormatError } from '../engine/error-handling/chat-error-classifier.js';
export { classifyAndFormatError };
