...
// 重新导出以保持向后兼容（skillWatcher.ts 等仍从 routes/skills.ts 导入）
export { scanWorkbuddySkills } from '../services/skillScanner.js';
export type { ScannedSkillMd } from '../services/skillScanner.js';

// ===================== SKILL.md 解析工具（基于 js-yaml） =====================
// parseSkillMd / scanWorkbuddySkills / ScannedSkillMd 已提取到 services/skillScanner.ts
// 此处保留导入以供本文件内部使用。
