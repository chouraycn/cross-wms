...
vi.mock("../engine/logging/subsystem.js", () => ({
  createSubsystemLogger: vi.fn(() => ({
    warn,
  })),
}));

import { buildTimeoutAbortSignal, fetchWithTimeout } from "../engine/utils/fetch-timeout.js";
import { MAX_SAFE_TIMEOUT_DELAY_MS } from "../engine/utils/timer-delay.js";
