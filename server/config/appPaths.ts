...
export const AppPaths = {
  ...
  skillsConfigDir: path.join(rootDir, 'skills', 'config'),
  skillsCacheDir: path.join(rootDir, 'skills', 'cache'),
  skillsDataDir: path.join(rootDir, 'skills', 'data'),
  clawhubCacheDir: path.join(rootDir, 'skills', 'cache', 'clawhub'),
  securityVerdictCacheDir: path.join(rootDir, 'skills', 'cache', 'security'),
  skillEnvConfigFile: path.join(rootDir, 'skills', 'config', 'env-overrides.json'),
  agentFilterConfigFile: path.join(rootDir, 'skills', 'config', 'agent-filters.json'),
  skillRegistryFile: path.join(rootDir, 'skills', 'config', 'registry.json'),
