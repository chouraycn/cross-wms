...
export function prepareGatewayPluginLoad(params: GatewayPluginBootstrapParams) {
  ...
  }) as { config: typeof activationSourceConfig; autoEnabledReasons?: Record<string, unknown> };
  const resolvedConfig =
    activationSourceConfig === params.cfg
      ? autoEnabled.config
      : mergeActivationSectionsIntoRuntimeConfig({
          runtimeConfig: params.cfg as any,
          activationConfig: autoEnabled.config as any,
        }) as typeof params.cfg;
  ...
  const loaded = loadGatewayPlugins({
    ...
    autoEnabledReasons: autoEnabled.autoEnabledReasons as any,
