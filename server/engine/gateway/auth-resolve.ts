...
/**
 * 降级 stub — 移植自 openclaw/src/gateway/auth-resolve.ts
 *
...
export type ResolvedGatewayAuthMode = unknown;

export type ResolvedGatewayAuthModeSource = unknown;

export type ResolvedGatewayAuth = unknown;
