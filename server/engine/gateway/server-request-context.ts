...
type GatewayServerLiveState = LiveState & { [key: string]: unknown };
...
export function createGatewayRequestContext(
  ...
  return {
    ...
    get cron() {
      return (params.runtimeState.cronState as any).cron;
    },
    get cronStorePath() {
      return (params.runtimeState.cronState as any).storePath;
    },
