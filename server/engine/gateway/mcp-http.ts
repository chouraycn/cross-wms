...
export async function startMcpLoopbackServer(..._args: any[]): Promise<any> {
  return Promise.resolve(undefined);
}

export async function ensureMcpLoopbackServer(..._args: any[]): Promise<any> {
  return Promise.resolve(undefined);
}

export async function closeMcpLoopbackServer(..._args: any[]): Promise<any> {
  return Promise.resolve(undefined);
}
