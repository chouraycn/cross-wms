...
import * as embeddedAgentHelpers from "../agents/embedded-agent-helpers.js";
const { isTimeoutErrorMessage } = embeddedAgentHelpers;
const classifyFailoverReason: (
  errorMessage: string,
  opts?: { provider?: string },
) => string | null | undefined = (embeddedAgentHelpers as any).classifyFailoverReason;
