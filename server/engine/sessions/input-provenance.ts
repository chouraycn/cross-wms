...
import type { InputProvenance, InputProvenanceKind, PersistedUserTurnMessage } from './types.js';

export type { InputProvenance, InputProvenanceKind } from './types.js';
...
export function shouldPreserveUserFacingSessionStateForInputProvenance(
  ...
  return sourceTool
    ? USER_FACING_SESSION_STATE_PRESERVING_SOURCE_TOOLS.has(sourceTool)
    : false;
}
