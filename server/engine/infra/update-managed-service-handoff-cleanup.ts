// 更新完成后清理托管服务 handoff 文件。
// 直接移植自 openclaw/src/infra/update-managed-service-handoff-cleanup.ts，
// 无外部依赖，纯 fs 实现。
...
export const MANAGED_SERVICE_UPDATE_HANDOFF_STALE_TTL_MS = 24 * 60_000;
