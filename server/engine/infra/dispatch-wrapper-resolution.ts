...
//    sortUniqueStrings，cross-wms 中该模块位于 ./string-normalization.js，
//    此处调整导入路径。
// 3. 源文件依赖 ./command-carriers.js（envInvocationUsesModifiers、
//    parseEnvInvocationPrelude、unwrapEnvInvocation），该文件已在 cross-wms
//    infra/ 中移植就绪。
// 4. 源文件依赖 ./exec-wrapper-tokens.js 和 ./inline-option-token.js，
//    这两个模块在 cross-wms 中均已就绪。
import { normalizeLowercaseStringOrEmpty } from "./string-coerce.js";
import { sortUniqueStrings } from "./string-normalization.js";
import {
