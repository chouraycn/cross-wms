...
// 心跳唤醒的集中冷却决策。
//
// 降级策略：源文件仅类型依赖 ./heartbeat-wake.js 的 HeartbeatWakeIntent 和
// HeartbeatWakeSource。cross-wms 中该模块位于 heartbeat/ 子目录
//（./heartbeat/heartbeat-wake.js），此处调整导入路径。
import type { HeartbeatWakeIntent, HeartbeatWakeSource } from "./heartbeat/heartbeat-wake.js";
