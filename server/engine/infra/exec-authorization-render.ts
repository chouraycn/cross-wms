...
// 从授权计划构建安全的 shell 命令文本。
//
// 降级策略：源文件依赖 ./command-explainer/types.js（已降级定义在 exec-authorization-plan.ts）、
// ./exec-approvals-allowlist.js（已降级合入 exec-approvals.ts）、
// ./exec-approvals-analysis.js（已移植），这里直接使用。
import type { SourceSpan } from "./exec-authorization-plan.js";
import type { ExecSegmentSatisfiedBy } from "./exec-approvals.js";
