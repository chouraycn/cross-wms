...
//
// 移植自 openclaw/src/plugins/installed-plugin-index-invalidation.ts。
//
// 降级策略：仅依赖本地 ./installed-plugin-index-config-path-scope.js、
// ./installed-plugin-index-hash.js、./installed-plugin-index-types.js，
// 无需进一步降级。行为与 openclaw 原版一致：对比前后 index 计算失效原因集合。
