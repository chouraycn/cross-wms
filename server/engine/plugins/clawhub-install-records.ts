...
> {
  return {
    ...
    clawhubFamily: fields.clawhubFamily as unknown as "code-plugin" | "bundle-plugin",
    clawhubChannel: fields.clawhubChannel as unknown as "official" | "community" | "private" | undefined,
