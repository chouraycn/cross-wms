...
// Stub exports for the plugin status API referenced by consumer modules.
export type PluginStatus = string;
export type PluginStatusInfo = any;
export function getPluginStatus(_pluginId: string): PluginStatusInfo {
  return undefined;
}
export function getPluginStatuses(): PluginStatusInfo[] {
  return [];
}
export function setPluginStatus(_pluginId: string, _status: PluginStatus): void {
  return undefined;
}
export function getPluginsByStatus(_status: PluginStatus): string[] {
  return [];
}
export function clearPluginStatus(_pluginId: string): void {
  return undefined;
}
