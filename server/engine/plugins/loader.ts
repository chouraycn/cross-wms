...
// Stub exports for plugin loader/version utilities referenced by consumer
// modules but not yet implemented in this module. They preserve the import
// surface while the real implementations are ported.
export type PluginLoadOrderNode = any;
export type DependencyResolutionResult = any;

export function parseVersion(_version: unknown): any {
  return undefined;
}
export function compareVersions(_a: unknown, _b: unknown): number {
  return 0;
}
export function satisfiesVersion(_version: unknown, _range: unknown): boolean {
  return true;
}
export function validateManifest(_manifest: unknown): any {
  return undefined;
}
export function resolveDependencyTree(_plugins: unknown): any {
  return undefined;
}
export function computeLoadOrder(_plugins: unknown): any {
  return undefined;
}
export function findIncompatiblePlugins(_plugins: unknown): any[] {
  return [];
}
export function findMissingDependencies(_plugins: unknown): any[] {
  return [];
}
export function logLoadOrder(_order: unknown): void {
  return undefined;
}
