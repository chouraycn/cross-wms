...
// Stub type alias for the registry entry surface referenced by consumer
// modules. Keeps imports resolvable while the full type is ported.
...
// Value stub for PluginRegistry so consumer modules that use it as a value
// (e.g. `PluginRegistry.find(...)`) resolve. The canonical type is re-exported
// above from registry-types.js; this const lives in the value namespace and
// does not conflict with the type-only re-export.
export const PluginRegistry: any = {
  find: (_pluginId?: string): any => undefined,
  list: (): any[] => [],
  has: (_pluginId?: string): boolean => false,
  get: (_pluginId?: string): any => undefined,
  entries: (): any[] => [],
};
