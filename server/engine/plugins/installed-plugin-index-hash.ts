...
//
// 移植自 openclaw/src/plugins/installed-plugin-index-hash.ts。
//
// 降级策略：
//  - 仅依赖 node:crypto、node:fs 与本地 ./manifest-types.js，无需降级。
//  - 与 openclaw 原版行为一致：使用 SHA-256 计算文件/JSON 哈希用于变更检测。
