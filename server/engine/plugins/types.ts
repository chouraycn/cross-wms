...
export type RealtimeVoiceProviderPlugin = {
  ...
  ) => Promise<RealtimeVoiceCloseReason>;
};
...
export type OpenClawPluginApi = {
  ...
  registerContextEngine: (
    id: string,
    factory: import("../context-engine/types.js").ContextEngineFactory,
  ) => void;
...
// Re-export PluginManifest from its canonical home so consumers importing from
// the plugin types barrel resolve correctly.
export type { PluginManifest } from "./manifest.js";

// Stub type aliases for plugin SDK surface members that are referenced by
// consumer modules but not yet defined in this barrel. These keep the public
// type contract importable while the underlying implementations are ported.
export type PluginContext = any;
export type PluginToolDefinition = any;
export type PluginCapabilityKind = any;
export type PluginLifecycle = any;
export type PluginInstance = any;
export type PluginSource = any;
export type PluginVersionRange = any;
export type PluginDependency = any;
export type PluginConfigSchema = any;
export type PluginConfigProperty = any;
export type PluginStorage = any;
export type PluginFetch = any;
export type PluginFetchInit = any;
export type PluginFetchResponse = any;
export type PluginEventBus = any;
export type PluginConfigAccessor = any;
export type PluginEvent = any;
export type PluginHealthMetrics = any;
export type PluginContractResult = any;
export type MarketplaceEntry = any;
export type MarketplaceSearchQuery = any;
export type MarketplaceSearchResult = any;
export type MarketplaceRating = any;
