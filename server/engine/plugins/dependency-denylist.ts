...
/** 在包清单中按名称、别名或 override 查找被阻止的依赖。 */
...
/** 在 node_modules 相对路径下查找被阻止的包文件别名。 */
