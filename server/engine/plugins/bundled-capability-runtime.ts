...
const CAPABILITY_VITEST_SHIM_ALIASES = [
  {
    ...
    target: path.resolve(__dirname, "./capability-runtime-vitest-shims/config-runtime.ts"),
  },
  {
    subpath: "media-runtime",
    target: path.resolve(__dirname, "./capability-runtime-vitest-shims/media-runtime.ts"),
  },
  {
    subpath: "provider-onboard",
    target: path.resolve(__dirname, "../plugin-sdk/provider-onboard.ts"),
  },
  {
    subpath: "speech-core",
    target: path.resolve(__dirname, "./capability-runtime-vitest-shims/speech-core.ts"),
  },
] as const;
