...
//
// 移植自 openclaw/src/plugins/contracts/inventory/bundled-capability-metadata.ts
//
// 降级策略：
//  - 原文件依赖 ../shared.js 的 uniqueStrings 函数，cross-wms 尚未移植 contracts/shared.ts。
//    这里内联 uniqueStrings 实现（行为一致）。
//  - 其余依赖（../../../infra/json-files.js、../../bundled-plugin-scan.js、../../manifest.js、
//    ../../sdk-alias.js）在 cross-wms 中均已移植，直接引用。
