...
const LEGACY_MODEL_CATALOG_BRIDGES = new Map([
  [path.join(REPO_ROOT, "src/agents/provider-id.ts"), "@cdf-know/model-catalog-core/provider-id"],
  [
    path.join(REPO_ROOT, "src/model-catalog/refs.ts"),
    "@cdf-know/model-catalog-core/model-catalog-refs",
  ],
  [
    path.join(REPO_ROOT, "src/model-catalog/normalize.ts"),
    "@cdf-know/model-catalog-core/model-catalog-normalize",
  ],
  [
    path.join(REPO_ROOT, "src/model-catalog/types.ts"),
    "@cdf-know/model-catalog-core/model-catalog-types",
  ],
  [
    path.join(REPO_ROOT, "src/config/model-refs.ts"),
    "@cdf-know/model-catalog-core/configured-model-refs",
  ],
  [
    path.join(REPO_ROOT, "src/shared/provider-model-id-normalization.ts"),
    "@cdf-know/model-catalog-core/provider-model-id-normalization",
  ],
  [
    path.join(REPO_ROOT, "src/plugin-sdk/provider-model-id-normalize.ts"),
    "@cdf-know/model-catalog-core/provider-model-id-normalize",
  ],
]);
