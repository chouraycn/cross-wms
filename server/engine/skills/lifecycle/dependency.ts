...
} from "./dependency-config.js";

// 重新导出以保持向后兼容
export { parseDependencyConfig } from "./dependency-config.js";

// ============================================================================
// 依赖配置解析
// ============================================================================
// parseDependencyConfig / normalizeDependency / normalizeConflict 已提取到
// ./dependency-config.ts（leaf 模块），此处仅导入使用。
