...
// Ported from openclaw/src/media-understanding/attachments.select.ts.
//
// Dependency adjustments:
//   - ../config/types.tools.js MediaUnderstandingAttachmentsConfig
//     → available in cross-wms at the same relative path
//   - ./attachments.normalize.js isAudioAttachment, isImageAttachment, isVideoAttachment
//     → ported alongside this file
//   - ./types.js MediaUnderstandingCapability
//     → already available in cross-wms
//   - ./attachments.normalize.js MediaAttachment
//     → cross-wms types.ts does not yet export MediaAttachment; the type is
//       defined in and re-exported from attachments.normalize.ts
