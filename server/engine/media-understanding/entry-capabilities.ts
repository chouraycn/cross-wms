/**
 * Media Understanding Entry Capabilities — 媒体能力解析
 *
 * 移植自 openclaw/src/media-understanding/entry-capabilities.ts。
 * 验证显式媒体能力标签，并从 registry 元数据推断 shared provider entries。
 */
