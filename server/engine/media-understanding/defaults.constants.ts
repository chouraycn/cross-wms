...
// Ported from openclaw media-understanding. The openclaw source re-exports
// from ../../packages/media-understanding-common/src/defaults.js; cross-wms
// inlines the constants here so the ported module stays self-contained.
