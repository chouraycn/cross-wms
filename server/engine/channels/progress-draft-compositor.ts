 ...
 * 移植自 openclaw/src/channels/progress-draft-compositor.ts
 *
 * 降级策略：
 *  - ../agents/embedded-agent-utils.js (formatReasoningMessage) → ./_openclaw-stubs.js
 *  - ../shared/text/code-regions.js (findCodeRegions, isInsideCode) → ./_openclaw-stubs.js
 *  - ../utils/directive-tags.js (stripInlineDirectiveTagsForDelivery) → ./_openclaw-stubs.js
 *  - ./progress-draft-lines.js (removeChannelProgressDraftLine) → 本目录已有实现
 *  - ./streaming.js (createChannelProgressDraftGate, ChannelProgressDraftLine,
 *    formatChannelProgressDraftText, isChannelProgressDraftWorkToolName,
 *    mergeChannelProgressDraftLine, normalizeChannelProgressDraftLineIdentity,
 *    resolveChannelProgressDraftMaxLineChars, resolveChannelProgressDraftMaxLines,
 *    resolveChannelStreamingProgressCommentary, resolveChannelStreamingPreviewToolProgress,
 *    resolveChannelStreamingSuppressDefaultToolProgressMessages,
 *    StreamingCompatEntry, StreamingMode) → ./_openclaw-stubs.js
 *
 * 降级行为：底层 streaming stub 始终返回 no-op / false / 空，导致 compositor 内部状态
 * 始终不渲染进度草稿。最终 reply 流程不受影响。
 */
import {
