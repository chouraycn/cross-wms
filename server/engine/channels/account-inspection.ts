/**
 * Channel account inspection helpers. — 移植自 openclaw/src/channels/account-inspection.ts
 *
 * 降级策略：
 *  - ../config/types.openclaw.js (OpenClawConfig) → cross-wms ../config/types/openclaw.js
 *  - ./account-snapshot-fields.js → 本目录已移植
 *  - ./account-summary.js → 本目录已移植
 *  - ./plugins/types.plugin.js (ChannelPlugin) → ./_openclaw-stubs.js
 *  - ./read-only-account-inspect.js → 本目录已移植
 */
...
import { type ChannelPlugin } from "./_openclaw-stubs.js";
