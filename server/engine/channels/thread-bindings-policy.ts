 ...
 *  - ../shared/thread-binding-lifecycle.js (resolveThreadBindingLifecycle,
 *    ThreadBindingLifecycleRecord) → ./_openclaw-stubs.js
 *  - ./plugins/index.js (getLoadedChannelPlugin) → ./_openclaw-stubs.js
 *  - ./plugins/thread-binding-api.js (resolveBundledChannelThreadBindingDefaultPlacement) →
 *    ./_openclaw-stubs.js
 */
import { MAX_DATE_TIMESTAMP_MS } from "./_openclaw-stubs.js";
import { normalizeLowercaseStringOrEmpty } from "../infra/string-coerce.js";
import {
  getLoadedChannelPlugin,
  normalizeAccountId,
  resolveBundledChannelThreadBindingDefaultPlacement,
  resolveSharedThreadBindingLifecycle,
  type ThreadBindingLifecycleRecord,
} from "./_openclaw-stubs.js";
import type { OpenClawConfig } from "../config/types/openclaw.js";

export { resolveSharedThreadBindingLifecycle as resolveThreadBindingLifecycle } from "./_openclaw-stubs.js";
