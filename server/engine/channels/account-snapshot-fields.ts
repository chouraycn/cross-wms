 ...
 *    ./_openclaw-stubs.js
 *  - ../utils.js (isRecord) / ../utils/boolean.js (asBoolean) →
 *    cross-wms 的 ../infra/{boolean-coerce}.js + 本地 isRecord 降级实现
 *  - ./plugins/types.core.js (ChannelAccountSnapshot) → ./_openclaw-stubs.js 中的 stub 类型
 */
import { asFiniteNumber } from "../infra/number-coercion.js";
