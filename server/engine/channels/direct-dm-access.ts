/**
 * Legacy direct-DM access resolver. — 移植自 openclaw/src/channels/direct-dm-access.ts
 *
 * 降级策略：
 *  - ../config/types.openclaw.js (OpenClawConfig) → cross-wms ../config/types/openclaw.js
 *  - ../plugin-sdk/access-groups.js (expandAllowFromWithAccessGroups, AccessGroupMembershipResolver)
 *    → ./_openclaw-stubs.js
 *  - ../plugin-sdk/channel-access-compat.js (DM_GROUP_ACCESS_REASON, DmGroupAccessReasonCode,
 *    readStoreAllowFromForDmPolicy, resolveDmGroupAccessWithLists) → ./_openclaw-stubs.js
 *  - ./plugins/types.public.js (ChannelId) → ./_openclaw-stubs.js
 *
 * 降级行为：底层 stub 始终返回 block 决策与空 allowFrom 列表。
 */
...
export type { AccessGroupMembershipResolver } from "./_openclaw-stubs.js";
