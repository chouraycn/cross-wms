...
// ---------------------------------------------------------------------------
// Core message domain types (direction, status, kind, parts, envelope, etc.)
// ---------------------------------------------------------------------------

/** Direction of a channel message relative to the local runtime. */
export type MessageDirection = "inbound" | "outbound";

/** Lifecycle status of a channel message. */
...
/** High-level kind of payload carried by a channel message. */
...
/** Logical kind of a single message part within a multi-part message. */
...
/** Lifecycle phase tracked for an inbound or outbound message. */
...
/** Sender identity attached to an inbound or outbound message. */
...
/** Single part of a multi-part channel message. */
...
/** Target descriptor for routing a channel message. */
...
/** Canonical channel message record used across inbound/outbound flows. */
...
/** Transport envelope wrapping a raw payload with routing metadata. */
...
/** Event emitted when a message advances through a lifecycle phase. */
...
/** Capability flags advertised by a channel for message handling. */
