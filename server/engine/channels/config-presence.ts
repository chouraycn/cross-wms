 ...
 *  - ../infra/outbound/channel-target.js (hasNonEmptyString) → ./_openclaw-stubs.js
 *  - ../plugins/discovery.js (PluginDiscoveryResult) → ./_openclaw-stubs.js
 *  - ../plugins/official-external-plugin-catalog.js → ./_openclaw-stubs.js
 *  - ../utils.js (isRecord) → ./_openclaw-stubs.js
 *  - ./plugins/bundled-ids.js (listBundledChannelIds) → ./_openclaw-stubs.js
 */
