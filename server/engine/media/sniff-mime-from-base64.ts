...
// Ported from openclaw/src/media/sniff-mime-from-base64.ts.
// Depends only on cross-wms media stubs (canonicalizeBase64, detectMime).
import { canonicalizeBase64, detectMime } from "./_openclaw-media-stubs.js";
