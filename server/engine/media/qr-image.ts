...
// Ported from openclaw media; temp workspace adapted to the local stub and
// qr-runtime adapted to the local lazy loader.
...
export async function writeQrPngTempFile(
  ...
  const workspace = tempWorkspace({ rootDir: opts.tmpRoot, prefix: dirPrefix });
