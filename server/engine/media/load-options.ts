// Outbound media load options shared by outbound attachment paths.
// Ported from openclaw/src/media/load-options.ts. Pure types and helpers
// with no external imports, so the file ports verbatim.
