...
// Ported from openclaw media. openclaw-specific dependencies are adapted:
//   - ../config/types.openclaw.js (OpenClawConfig) → opaque `unknown` config
//   - ../plugins/document-extractor-types.js + ./document-extractors.runtime.js
//     → local document-extractors.runtime stub (pdf-parse backed)
import type {
