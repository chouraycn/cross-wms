...
// Ported from openclaw/src/media/image-ops.ts.
//
// Dependency adjustments:
//   - rastermill (npm) → ./_porting-stubs.js (rastermill is not installed in
//     cross-wms; stubs provide types and throw RastermillUnavailableError at
//     call time so the module compiles and degrades gracefully when callers
//     catch ImageProcessorUnavailableError)
//   - ../infra/resolve-system-bin.js (resolveSystemBin) → ./_porting-stubs.js
