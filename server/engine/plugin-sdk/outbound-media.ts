...
//
// 移植自 openclaw/src/plugin-sdk/outbound-media.ts
// 降级策略：
//  - ../media/load-options.js 已存在（buildOutboundMediaLoadOptions、OutboundMediaAccess）。
//  - ./plugin-state-runtime.js 未移植，这里直接从 ../plugin-state/plugin-state-store.types.js
//    导入 PluginStateKeyedStore 类型。
//  - ./web-media.js 是本地降级 stub（loadWebMedia 调用时抛错），见 web-media.ts。
