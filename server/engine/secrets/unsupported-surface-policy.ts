...
// cross-wms stubs GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA as `unknown`; guard at runtime.
const bundledChannelMetadata = (
...
const bundledChannelUnsupportedSecretRefSurfacePatterns = [
  ...new Set(
    bundledChannelMetadata.flatMap((entry) =>
      "unsupportedSecretRefSurfacePatterns" in entry
        ? ((entry as { unsupportedSecretRefSurfacePatterns?: string[] })
