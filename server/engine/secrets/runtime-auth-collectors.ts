/**
 * Simplified port of openclaw/src/secrets/runtime-auth-collectors.ts
 *
 * Collects auth-profile and OAuth secret refs for runtime preparation.
 *
 * Simplification: assertNoOAuthSecretRefPolicyViolations from
 * agents/auth-profiles/policy.js is not ported yet. The stub is a no-op so
 * OAuth policy checks are skipped until policy.js is ported. Type safety is preserved.
 */
...
/**
 * Stub for assertNoOAuthSecretRefPolicyViolations from
 * agents/auth-profiles/policy.js (unported). No-op until policy.js is ported.
 */
