  ...
  defaultModels: [
    {
      ...
      cost: { input: 3, output: 15, cacheRead: 0.375, cacheWrite: 3.75 },
...
export const buildAnthropicHeaders = (ctx: { apiKey?: string; model?: { provider?: string } }) => {
...
export const buildAnthropicRequestBody = (ctx: unknown): Record<string, unknown> => {
  return {};
};

export const parseAnthropicStreamChunk = (_chunk: unknown): Array<Record<string, unknown>> => {
  return [];
};

export const parseAnthropicUsage = (_data: unknown) => {
  return { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 };
};

export const mapAnthropicFinishReason = (reason: string): string => {
...
export const splitAnthropicSystemMessages = (messages: Array<{ role: string; content: unknown }>) => {
  ...
  return { systemPrompt: systemBlocks.join("\n\n"), messages: filtered };
};

import type { Provider, ProviderFinishReasonMapper } from "./types.js";

export const anthropicProvider: Provider = {
  info: anthropicProviderInfo,
  buildHeaders: buildAnthropicHeaders as never,
  buildRequestBody: buildAnthropicRequestBody as never,
  parseStreamChunk: parseAnthropicStreamChunk as never,
  parseUsage: parseAnthropicUsage,
  mapFinishReason: mapAnthropicFinishReason as ProviderFinishReasonMapper,
};
