 ...
 * 降级策略：
 *  - normalizeOptionalLowercaseString 内联实现（来自 @cdf-know/normalization-core/string-coerce）
...
// 降级实现：normalizeOptionalLowercaseString 来自 @cdf-know/normalization-core/string-coerce
