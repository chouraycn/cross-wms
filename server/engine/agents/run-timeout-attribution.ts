/**
 * Agent run 超时归因 — 移植自 openclaw/src/agents/run-timeout-attribution.ts
 *
 * 降级策略：
 *  - 依赖 ../utils/boolean.js 的 asBoolean → 已在 ../infra/boolean-coerce.ts 中实现
 */
...
export { asBoolean as normalizeProviderStarted };
