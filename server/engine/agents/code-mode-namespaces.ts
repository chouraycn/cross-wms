 ...
 *
 * 移植自 openclaw/src/agents/code-mode-namespaces.ts。
 * 降级策略：
 *   - `isRecord` 来自 ../../packages/normalization-core/src/record-coerce.js（外部包），
 *     改为从 cross-wms 已有的 ../infra/record-coerce.js 导入。
 *   - `toCodeModeJsonSafe` 来自 ./code-mode-json.js（cross-wms 已有）。
 */
