 ...
 *
 * Ported from openclaw/src/agents/tools/web-tool-runtime-context.ts.
 *
 * cross-wms adjustments:
 * - Relative imports to `../../config/types.openclaw.js`,
 *   `../../secrets/runtime-state.js`, `../../secrets/runtime-web-tools-state.js`,
 *   `../../secrets/runtime-web-tools.types.js` are kept as-is because
 *   cross-wms exposes the same paths under server/engine/.
 * - Replaced `../../plugins/plugin-registry.js` with
 *   `../../plugins/plugin-registry-contributions.js` because cross-wms keeps
 *   `resolveManifestContractOwnerPluginId` in that module.
 */
