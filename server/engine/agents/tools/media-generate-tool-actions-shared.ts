 ...
 *
 * Ported from openclaw/src/agents/tools/media-generate-tool-actions-shared.ts.
 *
 * cross-wms adjustments:
 * - Replaced `../../../packages/media-generation-core/src/catalog.js` with the
 *   `@cdf-know/media-generation-core/catalog.js` path mapping.
 * - Replaced `../../secrets/provider-env-vars.js` with the cross-wms stub at
 *   `../../plugins/_stub_parent__secrets__provider_env_vars.js`.
 * - Replaced `./media-tool-shared.js` with `../media-tool-shared.js` because
 *   cross-wms keeps media-tool-shared at the agents/ folder, not agents/tools/.
 */
import {
  listMediaGenerationProviderModels,
  synthesizeMediaGenerationCatalogEntries,
  type MediaGenerationCatalogKind,
} from "@cdf-know/media-generation-core/catalog.js";
import type { OpenClawConfig } from "../../config/types.openclaw.js";
import { getProviderEnvVars } from "../../plugins/_stub_parent__secrets__provider_env_vars.js";
