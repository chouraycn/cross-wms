 ...
 *
 * Ported from openclaw/src/agents/tools/pdf-native-providers.ts.
 * cross-wms adjustments: replaced `../../utils.js` isRecord with
 * `../../infra/record-coerce.js`; cast stubbed transport helpers to expected shapes.
 */
...
export async function anthropicAnalyzePdf(params: {
  ...
  const url = resolveAnthropicMessagesUrl(params.baseUrl) as string | undefined;
