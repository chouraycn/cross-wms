...
export function normalizeStoredOverrideModel(model: any): any { return model; }
export function resolveAllowlistModelKey(model: any): string { return String(model ?? ""); }
...
export function resolveAllowedModelRef(modelRef: any): any { return modelRef; }
export function resolveReasoningDefault(): undefined { return undefined; }
export function normalizeProviderId(provider: any): string {
