 ...
 * Ported from openclaw/src/agents/cache-trace.ts.
 *
 * buildAgentTraceBase is inlined here because cross-wms trace-base.ts provides
 * a different trace-span implementation; the small base-field helper is kept
 * local to avoid mixing the two trace concepts.
 */
...
function buildAgentTraceBase(params: AgentTraceBase): AgentTraceBase {
  return {
    runId: params.runId,
