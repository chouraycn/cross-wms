/**
 * Context token resolution for provider/model pairs.
 *
...
/**
 * 本地降级类型：仅保留 context-resolution 关心的字段。
...
export type ContextTokenResolutionParams = {
  ...
  sourceCfg?: OpenClawConfigLike | null;
  provider?: string;
  model?: string;
...
function resolveConfiguredProviderContextTokens(
  cfg: OpenClawConfigLike | null | undefined,
  provider: string,
  model: string,
