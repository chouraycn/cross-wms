 ...
 *
 * 移植自 openclaw/src/agents/mcp-config-shared.ts。
 * 依赖 ../infra/host-env-security.js 中的 isDangerousHostEnvVarName、isDangerousHostInheritedEnvVarName、normalizeEnvVarKey。
 */
import {
