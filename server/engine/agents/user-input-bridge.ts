 ...
 *
 * User-input prompt formatting and answer parsing for agent harness.
 */
...
export async function deliverAgentHarnessUserInputPrompt(
  params: { onBlockReply?: (block: { text: string }) => Promise<void>; onPartialReply?: (partial: { text: string }) => Promise<void> },
  questions: readonly AgentHarnessUserInputQuestion[],
  options: AgentHarnessUserInputPromptOptions = {},
): Promise<void> {
