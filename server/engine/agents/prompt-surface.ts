 ...
 *
 * 移植自 openclaw/src/agents/prompt-surface.ts。
 * 降级策略：
 *   - `isOpenClawMainPromptSurface`、`AgentPromptSurfaceKind` 来自 ../plugins/agent-prompt-surface-kind.js
 *     （cross-wms 已有）。
 *   - `isAcpSessionKey`、`isSubagentSessionKey` 来自 ../sessions/session-key.js（cross-wms 已有）。
 */

import {
  isOpenClawMainPromptSurface,
  type AgentPromptSurfaceKind,
} from "../plugins/agent-prompt-surface-kind.js";
import { isAcpSessionKey, isSubagentSessionKey } from "../sessions/session-key.js";
