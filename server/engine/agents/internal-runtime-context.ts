/**
 * 内部 runtime-context 分隔符与剥离辅助函数。
 * 保护 runtime 生成的 prompt 块免受用户文本污染，并在重放或比较消息之前
 * 移除旧的上下文格式。
 */
/** 受保护的 OpenClaw runtime 上下文块的起始分隔符。 */
export const INTERNAL_RUNTIME_CONTEXT_BEGIN = "<<<BEGIN_OPENCLAW_INTERNAL_CONTEXT>>>";
/** 受保护的 OpenClaw runtime 上下文块的结束分隔符。 */
...
/** 抽取受保护的 runtime-context 块，并返回剩余可见文本。 */
...
/** 判断文本是否包含当前或旧版 runtime-context 标记。 */
...
/** 仅保留当前轮 runtime-context，要求其紧邻活跃用户消息之前。 */
