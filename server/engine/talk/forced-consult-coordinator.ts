 ...
 *
 * The relay may synthesize a consult when the model hesitates, but a
 ...
 *
 * 自包含实现，参考 openclaw/src/talk/forced-consult-coordinator.ts。
 * 内联 resolveTimerTimeoutMs，避免 ../shared/number-coercion.js 依赖。
 */
import {
...
/** 规范化定时器超时，钳制到 [min, max] 区间，非有限值返回 fallback。 */
