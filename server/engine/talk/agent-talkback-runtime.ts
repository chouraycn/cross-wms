/**
 * Debounced realtime voice talkback queue for delegated agent consults.
 *
 ...
 *
 * 自包含实现，参考 openclaw/src/talk/agent-talkback-runtime.ts。
 * 用本地 RuntimeLogger 类型替代 openclaw 的 plugins/runtime/types-core。
 */
