/**
 * Runtime Options Validation and Normalization
 * 运行时选项验证和规范化
 */

import type { AcpSessionRuntimeOptions, SessionAcpMeta } from "./types.js";
...
export function validateRuntimeOptionPatch(
  ...
  if (Object.prototype.hasOwnProperty.call(rawPatch, "runtimeMode")) {
  ...
  if (Object.prototype.hasOwnProperty.call(rawPatch, "thinking")) {
  ...
  if (Object.prototype.hasOwnProperty.call(rawPatch, "cwd")) {
  ...
  if (Object.prototype.hasOwnProperty.call(rawPatch, "permissionProfile")) {
  ...
  if (Object.prototype.hasOwnProperty.call(rawPatch, "timeoutSeconds")) {
  ...
  if (Object.prototype.hasOwnProperty.call(rawPatch, "backendExtras")) {
    ...
    if (rawExtras === undefined) {
      ...
      for (const [entryKey, entryValue] of entries) {
        const { key, value } = { key: validateBackendOptionKey(entryKey), value: validateBackendOptionValue(entryValue) };
        extras[key] = value;
      }
...
export function buildRuntimeControlSignature(options: AcpSessionRuntimeOptions): string {
  ...
  const extras = Object.entries(normalized.backendExtras ?? {}).sort(([a], [b]) =>
    a.localeCompare(b),
  );
