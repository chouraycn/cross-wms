...
export const ConfigIncludeError: new (...args: unknown[]) => any = undefined as unknown as new (...args: unknown[]) => any;
export type MissingEnvVarError = unknown;
export const MissingEnvVarError: new (...args: unknown[]) => any = undefined as unknown as new (...args: unknown[]) => any;
export type resolveShellEnvExpectedKeys = unknown;
export const resolveShellEnvExpectedKeys: (...args: unknown[]) => any = undefined as unknown as (...args: unknown[]) => any;
