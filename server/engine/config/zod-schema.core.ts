...
const ModelApiSchema = z.enum(MODEL_APIS as [string, ...string[]]);
...
const ModelCompatSchema = z
  .object({
    ...
    maxTokensField: z
      ...
      .optional(),
    thinkingFormat: z.enum(MODEL_THINKING_FORMATS as [string, ...string[]]).optional(),
...
type AssertAssignable<_T, U> = true;
