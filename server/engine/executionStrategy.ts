...
// ===================== 执行模式枚举与策略选项（从 execution-strategy-types 重导出） =====================

export { ExecutionMode } from './execution-strategy-types.js';
export type { ExecutionStrategyOptions } from './execution-strategy-types.js';

// 重导入以供本文件内部使用
import { ExecutionMode } from './execution-strategy-types.js';
