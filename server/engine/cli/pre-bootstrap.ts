...
export async function guardGatewayRunReset(..._args: unknown[]): Promise<void> {
  console.warn('guardGatewayRunReset is not available in cross-wms');
}

export async function recheckGatewayRunReset(..._args: unknown[]): Promise<void> {
  console.warn('recheckGatewayRunReset is not available in cross-wms');
}

export async function applyFinalGatewayRunConfigEnv(..._args: unknown[]): Promise<void> {
...
export async function reloadTrustedGatewayRunEnvironment(..._args: unknown[]): Promise<void> {
  console.warn('reloadTrustedGatewayRunEnvironment is not available in cross-wms');
}

export async function selectGatewayRunEnvironment(..._args: unknown[]): Promise<void> {
  console.warn('selectGatewayRunEnvironment is not available in cross-wms');
}

export async function prepareGatewayRunBootstrap(..._args: unknown[]): Promise<void> {
  console.warn('prepareGatewayRunBootstrap is not available in cross-wms');
}

export async function recheckGatewayRunBootstrap(..._args: unknown[]): Promise<void> {
