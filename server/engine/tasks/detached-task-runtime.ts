...
// 移植自 openclaw/src/tasks/detached-task-runtime.ts。
// 降级：runtime-internal.ts 和 task-executor.ts（openclaw 版）未移植，
...
import { cancelTaskById as cancelDetachedTaskRunByIdInCore } from "./_openclaw-task-stubs.js";
import {
