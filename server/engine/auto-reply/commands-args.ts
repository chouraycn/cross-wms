import type { CommandArgValues } from './commands-registry.js';
...
export function formatCommandArgs(commandKey: string, values: CommandArgValues): string | undefined {
  const formatter = COMMAND_ARG_FORMATTERS[commandKey];
  return formatter ? formatter(values) : undefined;
}
