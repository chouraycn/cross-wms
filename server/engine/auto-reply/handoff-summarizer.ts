 ...
 *
 * Ported from openclaw/src/auto-reply/handoff-summarizer.ts. The OpenClaw
 * `AgentMessage` type (from agents/runtime) is defined locally as a minimal
 * contract since cross-wms does not yet port the full agents runtime.
 */

/** Minimal agent message shape used to brief a fallback model. */
