...
// Local minimal stubs keep this public type file self-contained and type-safe
// without pulling in unavailable runtime implementations.
/** Minimal image content shape used by GetReplyOptions.images. */
