...
export async function handleBashChatCommand(params: {
  ...
  if (request.action === "stop") {
    ...
    const { killProcessTree } = await import('@openclaw-src/process/kill-tree.js');
    killProcessTree(pid);
    return {
