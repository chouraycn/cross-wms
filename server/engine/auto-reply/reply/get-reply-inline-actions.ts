...
import { generateSecureToken } from '@openclaw-src/infra/secure-random.js';
import { createLazyImportLoader } from '@openclaw-src/shared/lazy-promise.js';
import {
  listReservedChatSlashCommandNames,
  resolveSkillCommandInvocation,
} from '@openclaw-src/skills/discovery/chat-commands.js';
...
type SkillCommandsRuntime = typeof import('@openclaw-src/skills/discovery/chat-commands.runtime.js');
type SkillToolDispatchRuntime = typeof import('@openclaw-src/skills/runtime/tool-dispatch.js');
...
const skillCommandsRuntimeLoader = createLazyImportLoader<SkillCommandsRuntime>(
  () => import('@openclaw-src/skills/discovery/chat-commands.runtime.js'),
);
const skillToolDispatchRuntimeLoader = createLazyImportLoader<SkillToolDispatchRuntime>(
  () => import('@openclaw-src/skills/runtime/tool-dispatch.js'),
);
