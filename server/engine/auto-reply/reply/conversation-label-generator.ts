...
import { applyPreparedRuntimeAuthToModel } from '@openclaw-src/agents/provider-request-config.js';
import { prepareModelForSimpleCompletion } from '@openclaw-src/agents/simple-completion-transport.js';
import type { OpenClawConfig } from '@openclaw-src/config/types.openclaw.js';
import { logVerbose } from '@openclaw-src/globals.js';
import { completeSimple } from '@openclaw-src/llm/stream.js';
import type { TextContent } from '@openclaw-src/llm/types.js';
import { getRuntimeAuthForModel } from '@openclaw-src/plugins/runtime/runtime-model-auth.runtime.js';
