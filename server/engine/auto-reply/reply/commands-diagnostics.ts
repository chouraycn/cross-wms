...
import type { ExecApprovalRequest } from '@openclaw-src/infra/exec-approvals.js';
import type { InteractiveReply, MessagePresentationAction } from '@openclaw-src/interactive/payload.js';
import { executePluginCommand, matchPluginCommand } from '@openclaw-src/plugins/commands.js';
import type { PluginCommandDiagnosticsSession, PluginCommandResult } from '@openclaw-src/plugins/types.js';
