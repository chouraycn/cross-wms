...
import { buildOutboundSessionContext } from '@openclaw-src/infra/outbound/session-context.js';
import { hasReplyPayloadContent } from '@openclaw-src/interactive/payload.js';
import { normalizeAccountId } from '@openclaw-src/routing/account-id.js';
import { createLazyImportLoader } from '@openclaw-src/shared/lazy-promise.js';
import type { SilentReplyConversationType } from '@openclaw-src/shared/silent-reply-policy.js';
...
const messageRuntimeLoader = createLazyImportLoader(
  () => import('@openclaw-src/channels/message/runtime.js'),
);
