...
import { getCliSessionBinding } from '@openclaw-src/agents/cli-session.js';
import { resetRegisteredAgentHarnessSessions } from '@openclaw-src/agents/harness/registry.js';
import { cleanupBrowserSessionsForLifecycleEnd } from '@openclaw-src/browser-lifecycle-cleanup.js';
import { normalizeChatType } from '@openclaw-src/channels/chat-type.js';
import { resolveGroupSessionKey } from '@openclaw-src/config/sessions/group.js';
import {
  hasTerminalMainSessionTranscriptNewerThanRegistry,
  resolveSessionLifecycleTimestamps,
} from '@openclaw-src/config/sessions/lifecycle.js';
import { canonicalizeMainSessionAlias } from '@openclaw-src/config/sessions/main-session.js';
import { deriveSessionMetaPatch } from '@openclaw-src/config/sessions/metadata.js';
import { resolveSessionTranscriptPath, resolveStorePath } from '@openclaw-src/config/sessions/paths.js';
import { resolveResetPreservedSelection } from '@openclaw-src/config/sessions/reset-preserved-selection.js';
import {
...
} from '@openclaw-src/config/sessions/reset.js';
import {
  commitReplySessionInitialization,
  loadReplySessionInitializationSnapshot,
} from '@openclaw-src/config/sessions/session-accessor.js';
import { resolveSessionKey } from '@openclaw-src/config/sessions/session-key.js';
import { resolveMaintenanceConfigFromInput } from '@openclaw-src/config/sessions/store-maintenance.js';
...
import {
  ...
  type SessionEntry,
  type SessionScope,
} from '@openclaw-src/config/sessions/types.js';
import type { OpenClawConfig } from '@openclaw-src/config/types.openclaw.js';
import type { TtsAutoMode } from '@openclaw-src/config/types.tts.js';
import {
  forgetActiveSessionForShutdown,
  noteActiveSessionForShutdown,
} from '@openclaw-src/gateway/active-sessions-shutdown-tracker.js';
import { getSessionBindingService } from '@openclaw-src/infra/outbound/session-binding-service.js';
import { deliverSessionMaintenanceWarning } from '@openclaw-src/infra/session-maintenance-warning.js';
import { createSubsystemLogger } from '@openclaw-src/logging/subsystem.js';
import { getGlobalHookRunner } from '@openclaw-src/plugins/hook-runner-global.js';
import type { PluginHookSessionEndReason } from '@openclaw-src/plugins/hook-types.js';
import {
  buildAgentMainSessionKey,
  isAcpSessionKey,
  normalizeMainKey,
} from '@openclaw-src/routing/session-key.js';
import { isInterSessionInputProvenance } from '@openclaw-src/sessions/input-provenance.js';
import {
  normalizeDeliveryChannelRoute,
  normalizeSessionDeliveryFields,
} from '@openclaw-src/utils/delivery-context.shared.js';
