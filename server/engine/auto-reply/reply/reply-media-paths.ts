...
import { resolvePathFromInput, toRelativeWorkspacePath } from '@openclaw-src/agents/path-policy.js';
import {
  assertMediaNotDataUrl,
  resolveAllowedManagedMediaPath,
  resolveSandboxedMediaSource,
} from '@openclaw-src/agents/sandbox-paths.js';
...
import { resolveChannelAccountMediaMaxMb } from '@openclaw-src/media/configured-max-bytes.js';
import { resolveOutboundAttachmentFromUrl } from '@openclaw-src/media/outbound-attachment.js';
import { resolveAgentScopedOutboundMediaAccess } from '@openclaw-src/media/read-capability.js';
import { MEDIA_MAX_BYTES } from '@openclaw-src/media/store.js';
