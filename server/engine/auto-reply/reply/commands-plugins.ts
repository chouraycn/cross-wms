...
} from '@openclaw-src/cli/plugins-command-helpers.js';
import {
  persistPluginInstall,
  resolveInstallConfigMutationPreflights,
  selectInstallMutationWriteOptions,
} from '@openclaw-src/cli/plugins-install-persist.js';
import type { ConfigSnapshotForInstallPersist } from '@openclaw-src/cli/plugins-install-persist.js';
import { refreshPluginRegistryAfterConfigMutation } from '@openclaw-src/cli/plugins-registry-refresh.js';
import { readConfigFileSnapshot, readConfigFileSnapshotForWrite } from '@openclaw-src/config/config.js';
...
import { resolveArchiveKind } from '@openclaw-src/infra/archive.js';
import { parseClawHubPluginSpec } from '@openclaw-src/infra/clawhub.js';
import { formatErrorMessage } from '@openclaw-src/infra/errors.js';
import { installPluginFromClawHub } from '@openclaw-src/plugins/clawhub.js';
import { installPluginFromGitSpec, parseGitPluginSpec } from '@openclaw-src/plugins/git-install.js';
import { installPluginFromNpmSpec, installPluginFromPath } from '@openclaw-src/plugins/install.js';
...
import type { PluginRecord } from '@openclaw-src/plugins/registry.js';
import {
