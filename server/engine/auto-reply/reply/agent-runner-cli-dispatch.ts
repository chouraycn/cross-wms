...
import { extractToolResultText } from '@openclaw-src/agents/embedded-agent-subscribe.tools.js';
import { inferToolMetaFromArgs } from '@openclaw-src/agents/embedded-agent-utils.js';
import type { EmbeddedAgentRunResult } from '@openclaw-src/agents/embedded-agent.js';
import {
