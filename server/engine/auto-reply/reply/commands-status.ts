...
import { buildStatusText } from '@openclaw-src/status/status-text.js';
import type { BuildStatusTextParams } from '@openclaw-src/status/status-text.types.js';
import type { ReplyPayload } from "../types.js";
import { requireCommandFlagEnabled } from "./command-gates.js";
import type { CommandContext } from "./commands-types.js";
export { buildStatusText } from '@openclaw-src/status/status-text.js';
...
export async function buildStatusPluginsReply(
  ...
  try {
    const { collectInstalledPluginHealthSnapshot } =
      await import('@openclaw-src/status/status-plugin-health.runtime.js');
