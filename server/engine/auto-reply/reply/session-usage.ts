...
import {
  ...
  setCliSessionId,
} from '@openclaw-src/agents/cli-session.js';
import {
  deriveSessionTotalTokens,
  hasNonzeroUsage,
  type NormalizedUsage,
} from '@openclaw-src/agents/usage.js';
...
import { resolveNonNegativeNumber } from '@openclaw-src/shared/number-coercion.js';
import { estimateUsageCost, resolveModelCostConfig } from '@openclaw-src/utils/usage-format.js';

function applyCliSessionIdToSessionPatch(
  params: {
    providerUsed?: string;
    cliSessionId?: string;
    cliSessionBinding?: import('@openclaw-src/config/sessions.js').CliSessionBinding;
