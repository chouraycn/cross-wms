...
} from '@openclaw-src/agents/bootstrap-prompt.js';
import { appendCronStyleCurrentTimeLine } from '@openclaw-src/agents/current-time.js';
import { resolveEffectiveToolInventory } from '@openclaw-src/agents/tools-effective-inventory.js';
import { isWorkspaceBootstrapPending } from '@openclaw-src/agents/workspace.js';
