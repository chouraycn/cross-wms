 ...
 *
 * Ported from openclaw/src/auto-reply/heartbeat-tool-response.ts. The OpenClaw
 * normalization-core coercers (`isRecord`, `normalizeOptionalString`) are
 * inlined. `HEARTBEAT_TOKEN` is imported from the ported `heartbeat.js`.
 */
