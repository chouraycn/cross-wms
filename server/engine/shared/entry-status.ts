...
// Ported from openclaw/src/shared/entry-status.ts.
//
// Dependency adjustments:
//   - ./entry-metadata.js (resolveEmojiAndHomepage) → ./_porting-stubs.js
//   - ./requirements.js (evaluateRequirementsFromMetadataWithRemote + types)
//     → ./_porting-stubs.js
//   The backing modules are not yet ported; _porting-stubs.ts provides the
//   public types and a simplified evaluator so this helper stays type-safe.
import { resolveEmojiAndHomepage } from "./_porting-stubs.js";
import {
