...
import { identityHasValues, parseIdentityMarkdown } from "@openclaw-src/agents/identity-file.js";
import { DEFAULT_IDENTITY_FILENAME } from "@openclaw-src/agents/workspace.js";
import { replaceConfigFile } from "@openclaw-src/config/config.js";
import { logConfigUpdated } from "@openclaw-src/config/logging.js";
import type { IdentityConfig } from "@openclaw-src/config/types.js";
