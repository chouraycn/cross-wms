...
import { formatLookupMiss } from "@openclaw-src/cli/error-format.js";
...
import { loadCronJobsStoreSync, resolveCronJobsStorePath } from "@openclaw-src/cron/store.js";
import type { RuntimeEnv } from "@openclaw-src/runtime.js";
import { getTaskById, updateTaskNotifyPolicyById } from "@openclaw-src/tasks/runtime-internal.js";
import { cancelDetachedTaskRunById } from "@openclaw-src/tasks/task-executor.js";
import { listTaskFlowAuditFindings } from "@openclaw-src/tasks/task-flow-registry.audit.js";
import {
  getInspectableTaskFlowAuditSummary,
  previewTaskFlowRegistryMaintenance,
  runTaskFlowRegistryMaintenance,
} from "@openclaw-src/tasks/task-flow-registry.maintenance.js";
import {
...
} from "@openclaw-src/tasks/task-registry.maintenance.js";
import {
  reconcileInspectableTasks,
  reconcileTaskLookupToken,
} from "@openclaw-src/tasks/task-registry.reconcile.js";
import { summarizeTaskRecords } from "@openclaw-src/tasks/task-registry.summary.js";
import type { TaskNotifyPolicy, TaskRecord } from "@openclaw-src/tasks/task-registry.types.js";
import {
...
async function tryCancelCronTaskViaGateway(
  ...
  try {
    const { callGateway } = await import("@openclaw-src/gateway/call.js");
