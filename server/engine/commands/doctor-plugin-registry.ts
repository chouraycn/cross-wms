...
import { tryReadJsonSync } from "@openclaw-src/infra/json-files.js";
import type { BundledPluginSource } from "@openclaw-src/plugins/bundled-sources.js";
import { resolveDefaultPluginNpmDir } from "@openclaw-src/plugins/install-paths.js";
import {
  loadInstalledPluginIndexInstallRecords,
  type InstalledPluginIndexRecordStoreOptions,
} from "@openclaw-src/plugins/installed-plugin-index-records.js";
import { loadInstalledPluginIndex } from "@openclaw-src/plugins/installed-plugin-index.js";
import { hasRetainedManagedNpmInstallMarker } from "@openclaw-src/plugins/managed-npm-retention.js";
import { listManagedPluginNpmRootsSync } from "@openclaw-src/plugins/npm-project-roots.js";
import {
  auditOpenClawPeerDependenciesInManagedNpmRoot,
  relinkOpenClawPeerDependenciesInManagedNpmRoot,
} from "@openclaw-src/plugins/plugin-peer-link.js";
import { refreshPluginRegistry } from "@openclaw-src/plugins/plugin-registry.js";
import {
  listStaleLocalBundledPluginInstallRecords,
  type StaleLocalBundledPluginInstallRecord,
} from "@openclaw-src/plugins/stale-local-bundled-plugin-install-records.js";
