...
export type AgentHealthSummary = {
  ...
  name?: string;
  isDefault: boolean;
  heartbeat: import("@openclaw-src/infra/heartbeat-summary.js").HeartbeatSummary;
...
type ModelPricingHealthSummary =
  import("@openclaw-src/gateway/model-pricing-cache-state.js").GatewayModelPricingHealth;
...
export type HealthSummary = {
  ...
  ts: number;
  durationMs: number;
  eventLoop?: import("@openclaw-src/gateway/server/event-loop-health.js").GatewayEventLoopHealth;
