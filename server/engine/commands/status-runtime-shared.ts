...
import { resolveDefaultAgentDir } from "@openclaw-src/agents/agent-scope.js";
...
const providerUsageLoader = createLazyImportLoader(() => import("@openclaw-src/infra/provider-usage.js"));
const securityAuditModuleLoader = createLazyImportLoader(
  () => import("@openclaw-src/security/audit.runtime.js"),
);
const readOnlyChannelPluginsModuleLoader = createLazyImportLoader(
  () => import("@openclaw-src/channels/plugins/read-only.js"),
);
