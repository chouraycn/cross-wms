...
import { safeParseWithSchema } from "@openclaw-src/utils/zod-parse.js";
...
type ConfigIOModule = typeof import("@openclaw-src/config/config.js");
type ConfigLoggingModule = typeof import("@openclaw-src/config/logging.js");

const agentWorkspaceModuleLoader = createLazyImportLoader<AgentWorkspaceModule>(
  () => import("@openclaw-src/agents/workspace.js"),
);
const configIOModuleLoader = createLazyImportLoader<ConfigIOModule>(
  () => import("@openclaw-src/config/config.js"),
);
const configLoggingModuleLoader = createLazyImportLoader<ConfigLoggingModule>(
  () => import("@openclaw-src/config/logging.js"),
);
...
async function resolveDefaultSessionTranscriptsDir(): Promise<string> {
  const { resolveSessionTranscriptsDir } = await import("@openclaw-src/config/sessions.js");
