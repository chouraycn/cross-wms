...
import { buildGatewayInstallPlan, gatewayInstallErrorHint } from "@openclaw-src/daemon-install-helpers.js";
import { DEFAULT_GATEWAY_DAEMON_RUNTIME, isGatewayDaemonRuntime } from "@openclaw-src/daemon-runtime.js";
import { resolveGatewayInstallToken } from "@openclaw-src/gateway-install-token.js";
import type { OnboardOptions } from "@openclaw-src/onboard-types.js";
import { ensureSystemdUserLingerNonInteractive } from "@openclaw-src/systemd-linger.js";
