...
import type { SecretInput } from "@openclaw-src/config/types.secrets.js";
import { formatErrorMessage } from "@openclaw-src/infra/errors.js";
import { resolveManifestDeprecatedProviderAuthChoice } from "@openclaw-src/plugins/provider-auth-choices.js";
import type { RuntimeEnv } from "@openclaw-src/runtime.js";
import { resolveDefaultSecretProviderAlias } from "@openclaw-src/secrets/ref-contract.js";
import {
  formatDeprecatedNonInteractiveAuthChoiceError,
  isDeprecatedAuthChoice,
  resolveDeprecatedAuthChoiceReplacement,
} from "@openclaw-src/auth-choice-legacy.js";
import { normalizeSecretInputModeInput } from "@openclaw-src/auth-choice.apply-helpers.js";
import { normalizeApiKeyTokenProviderAuthChoice } from "@openclaw-src/auth-choice.apply.api-providers.js";
import {
  applyCustomApiConfig,
  CustomApiError,
  parseNonInteractiveCustomApiFlags,
  resolveCustomProviderId,
} from "@openclaw-src/onboard-custom-config.js";
import type { AuthChoice, OnboardOptions } from "@openclaw-src/onboard-types.js";
import { resolveNonInteractiveApiKey } from "@openclaw-src/api-keys.js";
