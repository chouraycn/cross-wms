...
import { isValidEnvSecretRefId, resolveSecretInputRef } from "@openclaw-src/config/types.secrets.js";
...
import { normalizeGatewayTokenInput, randomToken } from "@openclaw-src/onboard-helpers.js";
