...
import { normalizeEmbeddedAgentRuntime } from "@openclaw-src/agents/agent-runtime-id.js";
import { resolveDefaultAgentDir } from "@openclaw-src/agents/agent-scope-config.js";
import { resolveCliBackendConfig } from "@openclaw-src/agents/cli-backends.js";
...
import { getRegisteredAgentHarness } from "@openclaw-src/agents/harness/registry.js";
...
} from "@openclaw-src/context-engine/host-compat.js";
import { ensureContextEnginesInitialized } from "@openclaw-src/context-engine/init.js";
import { getContextEngineFactory, resolveContextEngine } from "@openclaw-src/context-engine/registry.js";
import type { ContextEngineInfo } from "@openclaw-src/context-engine/types.js";
import { ensurePluginRegistryLoaded } from "@openclaw-src/plugins/runtime/runtime-registry-loader.js";
import { defaultSlotIdForKey } from "@openclaw-src/plugins/slots.js";
