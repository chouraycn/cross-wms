...
} from "@openclaw-src/config/plugin-install-config-migration.js";
...
} from "@openclaw-src/plugins/installed-plugin-index-store.js";
import {
  loadInstalledPluginIndex,
  type InstalledPluginIndex,
  type InstalledPluginIndexRecord,
  type LoadInstalledPluginIndexParams,
} from "@openclaw-src/plugins/installed-plugin-index.js";
import { loadPluginManifestRegistryForInstalledIndex } from "@openclaw-src/plugins/manifest-registry-installed.js";
...
async function readMigrationConfig(
  ...
  const configModule = await import("@openclaw-src/config/config.js");
