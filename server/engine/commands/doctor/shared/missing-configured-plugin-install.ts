...
} from "@openclaw-src/channels/config-presence.js";
import { listRawChannelPluginCatalogEntries } from "@openclaw-src/channels/plugins/catalog.js";
import type { OpenClawConfig } from "@openclaw-src/config/types.openclaw.js";
import type { PluginInstallRecord } from "@openclaw-src/config/types.plugins.js";
import { parseClawHubPluginSpec } from "@openclaw-src/infra/clawhub-spec.js";
import {
  compareOpenClawReleaseVersions,
  isOpenClawOrgNpmSpec,
  parseRegistryNpmSpec,
} from "@openclaw-src/infra/npm-registry-spec.js";
import {
  normalizeUpdateChannel,
  resolveRegistryUpdateChannel,
  type UpdateChannel,
} from "@openclaw-src/infra/update-channels.js";
import { resolveConfiguredChannelPresencePolicy } from "@openclaw-src/plugins/channel-plugin-ids.js";
import { buildClawHubPluginInstallRecordFields } from "@openclaw-src/plugins/clawhub-install-records.js";
import { CLAWHUB_INSTALL_ERROR_CODE, installPluginFromClawHub } from "@openclaw-src/plugins/clawhub.js";
import { collectConfiguredMemoryEmbeddingProviderIds } from "@openclaw-src/plugins/gateway-startup-plugin-ids.js";
import { collectConfiguredSpeechProviderIds } from "@openclaw-src/plugins/gateway-startup-speech-providers.js";
import {
  resolveClawHubInstallSpecsForUpdateChannel,
  resolveNpmInstallSpecsForUpdateChannel,
} from "@openclaw-src/plugins/install-channel-specs.js";
import {
  resolveDefaultPluginNpmDir,
  resolveDefaultPluginExtensionsDir,
  resolvePluginNpmPackageDir,
  resolvePluginInstallDir,
} from "@openclaw-src/plugins/install-paths.js";
import { installPluginFromNpmSpec } from "@openclaw-src/plugins/install.js";
import { loadInstalledPluginIndexInstallRecords } from "@openclaw-src/plugins/installed-plugin-index-records.js";
import { writePersistedInstalledPluginIndexInstallRecords } from "@openclaw-src/plugins/installed-plugin-index-records.js";
import { loadInstalledPluginIndex } from "@openclaw-src/plugins/installed-plugin-index.js";
import {
  buildNpmResolutionInstallFields,
  resolveNpmInstallRecordSpec,
} from "@openclaw-src/plugins/installs.js";
import { readLegacyNpmPluginDeclaration } from "@openclaw-src/plugins/legacy-npm-declaration.js";
...
} from "@openclaw-src/plugins/official-external-plugin-catalog.js";
import type { PluginMetadataSnapshot } from "@openclaw-src/plugins/plugin-metadata-snapshot.types.js";
import { resolveProviderInstallCatalogEntries } from "@openclaw-src/plugins/provider-install-catalog.js";
import { updateNpmInstalledPlugins } from "@openclaw-src/plugins/update.js";
import {
  resolveWebSearchInstallCatalogEntriesForEnv,
  resolveWebSearchInstallCatalogEntry,
} from "@openclaw-src/plugins/web-search-install-catalog.js";
import { resolveUserPath } from "@openclaw-src/utils.js";
