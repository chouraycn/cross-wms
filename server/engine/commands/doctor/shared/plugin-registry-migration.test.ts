...
import type { PluginCandidate } from "@openclaw-src/plugins/discovery.js";
import {
  readPersistedInstalledPluginIndex,
  resolveInstalledPluginIndexStorePath,
  writePersistedInstalledPluginIndex,
} from "@openclaw-src/plugins/installed-plugin-index-store.js";
import type { InstalledPluginIndex } from "@openclaw-src/plugins/installed-plugin-index.js";
import {
  cleanupTrackedTempDirs,
  makeTrackedTempDir,
} from "@openclaw-src/plugins/test-helpers/fs-fixtures.js";
import { runOpenClawStateWriteTransaction } from "@openclaw-src/state/openclaw-state-db.js";
import {
