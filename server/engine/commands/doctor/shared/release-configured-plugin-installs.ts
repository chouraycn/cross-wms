...
import { isChannelConfigured } from "@openclaw-src/config/channel-configured.js";
import { detectPluginAutoEnableCandidates } from "@openclaw-src/config/plugin-auto-enable.js";
import type { OpenClawConfig } from "@openclaw-src/config/types.openclaw.js";
import { compareOpenClawVersions } from "@openclaw-src/config/version.js";
import {
  createDeferredConfiguredPluginRepairDoctorResult,
  type UpdatePostInstallDoctorResult,
} from "@openclaw-src/infra/update-doctor-result.js";
