...
} from "@openclaw-src/agents/auth-profiles/legacy-oauth-ref.js";
import {
  areOAuthCredentialsEquivalent,
  hasUsableOAuthCredential,
  isSafeToAdoptMainStoreOAuthIdentity,
} from "@openclaw-src/agents/auth-profiles/oauth-shared.js";
...
import { updateAuthProfileStoreWithLock } from "@openclaw-src/agents/auth-profiles/store.js";
import type { AuthProfileStore, OAuthCredential } from "@openclaw-src/agents/auth-profiles/types.js";
