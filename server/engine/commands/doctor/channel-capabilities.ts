...
import { findBundledPackageChannelMetadata } from "@openclaw-src/plugins/bundled-package-channel-metadata.js";
import type { PluginPackageChannelDoctorCapabilities } from "@openclaw-src/plugins/manifest.js";
