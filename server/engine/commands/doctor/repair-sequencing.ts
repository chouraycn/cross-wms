...
} from "@openclaw-src/config/plugin-auto-enable.js";
import {
  collectOpenAICodexAuthProfileStoreIdMap,
  maybeMigrateAuthProfileJsonStoresToSqlite,
  maybeRepairOpenAICodexAuthConfig,
  maybeRepairOpenAICodexAuthProfileStores,
} from "@openclaw-src/doctor-auth-flat-profiles.js";
import { maybeRepairLegacyOAuthSidecarProfiles } from "@openclaw-src/doctor-auth-oauth-sidecar.js";
import {
  maybeRepairManagedNpmOpenClawPeerLinks,
  maybeRepairStaleManagedNpmBundledPlugins,
} from "@openclaw-src/doctor-plugin-registry.js";
