...
import { isChannelVisibleInSetup } from "@openclaw-src/channels/plugins/exposure.js";
import { normalizeChannelMeta } from "@openclaw-src/channels/plugins/meta-normalization.js";
import type { ChannelPlugin } from "@openclaw-src/channels/plugins/types.plugin.js";
import type { ChannelMeta } from "@openclaw-src/channels/plugins/types.public.js";
import { isStaticallyChannelConfigured } from "@openclaw-src/config/channel-configured-shared.js";
import { applyPluginAutoEnable } from "@openclaw-src/config/plugin-auto-enable.js";
import type { OpenClawConfig } from "@openclaw-src/config/types.openclaw.js";
import { listManifestChannelContributionIds } from "@openclaw-src/plugins/manifest-contribution-ids.js";
