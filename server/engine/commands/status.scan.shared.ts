...
import { resolveGatewayProbeTarget } from "@openclaw-src/gateway/probe-target.js";
import type { GatewayProbeResult, probeGateway as probeGatewayFn } from "@openclaw-src/gateway/probe.js";
import { requireNodeSqlite } from "@openclaw-src/infra/node-sqlite.js";
import {
  MEMORY_INDEX_CHUNKS_TABLE,
  MEMORY_INDEX_META_TABLE,
  MEMORY_INDEX_SOURCES_TABLE,
  type MemoryProviderStatus,
} from "@openclaw-src/memory-host-sdk/engine-storage.js";
...
import { resolveTailscalePublishedHost } from "@openclaw-src/shared/tailscale-status.js";
...
const probeGatewayModuleLoader = createLazyImportLoader(() => import("@openclaw-src/gateway/probe.js"));
const gatewayCallModuleLoader = createLazyImportLoader(() => import("@openclaw-src/gateway/call.js"));
