...
import type { collectChannelStatusIssues as collectChannelStatusIssuesFn } from "@openclaw-src/infra/channels-status-issues.js";
import { resolveOsSummary } from "@openclaw-src/infra/os-summary.js";
...
const configModuleLoader = createLazyImportLoader(() => import("@openclaw-src/config/config.js"));
const commandConfigResolutionModuleLoader = createLazyImportLoader(
  () => import("@openclaw-src/cli/command-config-resolution.js"),
);
