...
} from "@openclaw-src/config/gateway-dispatch-config.js";
...
import { ADMIN_SCOPE } from "@openclaw-src/gateway/operator-scopes.js";
import { parseStrictNonNegativeInteger } from "@openclaw-src/infra/parse-finite-number.js";
import { routeLogsToStderr } from "@openclaw-src/logging/console.js";
import {
...
import { normalizeMessageChannel } from "@openclaw-src/utils/message-channel-normalize.js";
...
type RuntimeConfigModule = typeof import("@openclaw-src/config/io.js");
...
async function loadRuntimeConfig(): Promise<OpenClawConfig> {
  runtimeConfigModulePromise ??= import("@openclaw-src/config/io.js");
