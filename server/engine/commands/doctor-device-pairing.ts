...
import {
  ...
  type PairedDevice,
} from "@openclaw-src/infra/device-pairing.js";
import { JsonFileReadError, tryReadJsonSync } from "@openclaw-src/infra/json-files.js";
import type { DeviceAuthStore } from "@openclaw-src/shared/device-auth.js";
import { normalizeDeviceAuthScopes } from "@openclaw-src/shared/device-auth.js";
import { roleScopesAllow } from "@openclaw-src/shared/operator-scope-compat.js";
