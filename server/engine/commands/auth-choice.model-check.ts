...
import { hasUsableCustomProviderApiKey, resolveEnvApiKey } from "@openclaw-src/agents/model-auth.js";
...
import { buildProviderAuthRecoveryHint } from "@openclaw-src/agents/provider-auth-recovery-hint.js";
