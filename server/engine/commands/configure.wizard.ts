...
import { ConfigMutationConflictError } from "@openclaw-src/config/mutate.js";
import type { OpenClawConfig } from "@openclaw-src/config/types.openclaw.js";
import { ensureControlUiAssetsBuilt } from "@openclaw-src/infra/control-ui-assets.js";
import { resolvePluginContributionOwners } from "@openclaw-src/plugins/plugin-registry.js";
...
import { isPlainObject, resolveUserPath } from "@openclaw-src/utils.js";
...
import { resolveSetupSecretInputString } from "@openclaw-src/wizard/setup.secret-input.js";
...
type SetupPluginConfigModule = typeof import("@openclaw-src/wizard/setup.plugin-config.js");
...
async function promptWebToolsConfig(
  ...
  const { isCodexNativeWebSearchRelevant } = await import("@openclaw-src/agents/codex-native-web-search.js");
