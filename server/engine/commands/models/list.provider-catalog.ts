...
import { loadAuthProfileStoreWithoutExternalProfiles } from "@openclaw-src/agents/auth-profiles/store.js";
import {
  buildAgentModelCatalogCacheKey,
  readCachedAgentModelCatalog,
  writeCachedAgentModelCatalog,
} from "@openclaw-src/agents/model-catalog-state-cache.js";
import { buildModelsJsonSourceFingerprint } from "@openclaw-src/agents/models-config.js";
import {
  createProviderApiKeyResolver,
  createProviderAuthResolver,
} from "@openclaw-src/agents/models-config.providers.secrets.js";
import type { ModelProviderConfig } from "@openclaw-src/config/types.models.js";
...
} from "@openclaw-src/plugins/plugin-registry.js";
import {
...
} from "@openclaw-src/plugins/provider-discovery.js";
import {
  resolveBundledProviderCompatPluginIds,
  resolveOwningPluginIdsForProviderRef,
} from "@openclaw-src/plugins/providers.js";
import type { ProviderPlugin } from "@openclaw-src/plugins/types.js";
...
export async function resolveProviderCatalogPluginIdsForFilter(params: {
  ...
  const { resolveProviderContractPluginIdsForProviderAlias } =
    await import("@openclaw-src/plugins/contracts/registry.js");
