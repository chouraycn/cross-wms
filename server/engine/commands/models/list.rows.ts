...
} from "@openclaw-src/agents/model-suppression.js";
import type { ModelDefinitionConfig, ModelProviderConfig } from "@openclaw-src/config/types.models.js";
...
import type { ProviderRuntimeModel } from "@openclaw-src/plugins/provider-runtime-model.types.js";
import { normalizeProviderResolvedModelWithPlugin } from "@openclaw-src/plugins/provider-runtime.js";
...
type ModelCatalogModule = typeof import("@openclaw-src/agents/model-catalog.js");
type ModelResolverModule = typeof import("@openclaw-src/agents/embedded-agent-runner/model.js");
...
const modelCatalogModuleLoader = createLazyImportLoader<ModelCatalogModule>(
  () => import("@openclaw-src/agents/model-catalog.js"),
);
const modelResolverModuleLoader = createLazyImportLoader<ModelResolverModule>(
  () => import("@openclaw-src/agents/embedded-agent-runner/model.js"),
);
