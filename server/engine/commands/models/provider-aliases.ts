...
import { loadPluginManifest, type PluginManifestModelCatalog } from "@openclaw-src/plugins/manifest.js";
import type { PluginMetadataSnapshot } from "@openclaw-src/plugins/plugin-metadata-snapshot.js";
