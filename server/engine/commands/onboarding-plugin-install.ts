...
import { isOpenClawOrgNpmSpec, parseRegistryNpmSpec } from "@openclaw-src/infra/npm-registry-spec.js";
import { normalizeUpdateChannel, resolveRegistryUpdateChannel } from "@openclaw-src/infra/update-channels.js";
import {
  findBundledPluginSourceInMap,
  resolveBundledPluginSources,
} from "@openclaw-src/plugins/bundled-sources.js";
import { CLAWHUB_INSTALL_ERROR_CODE } from "@openclaw-src/plugins/clawhub-error-codes.js";
...
} from "@openclaw-src/plugins/enable.js";
import {
...
} from "@openclaw-src/plugins/install-overrides.js";
import { resolveDefaultPluginExtensionsDir } from "@openclaw-src/plugins/install-paths.js";
import {
  installPluginFromNpmSpec,
  installPluginFromNpmPackArchive,
  type InstallPluginResult,
} from "@openclaw-src/plugins/install.js";
import { clearLoadInstalledPluginIndexInstallRecordsCache } from "@openclaw-src/plugins/installed-plugin-index-records.js";
import {
...
import { clearPluginMetadataLifecycleCaches } from "@openclaw-src/plugins/plugin-metadata-lifecycle.js";
import type { RuntimeEnv } from "@openclaw-src/runtime.js";
import { withTimeout } from "@openclaw-src/utils/with-timeout.js";
import { VERSION } from "@openclaw-src/version.js";
import { t } from "@openclaw-src/wizard/i18n/index.js";
...
type InstallPluginFromClawHubResult = Awaited<
  ReturnType<(typeof import("@openclaw-src/plugins/clawhub.js"))["installPluginFromClawHub"]>
>;
...
> {
  ...
  try {
    const { installPluginFromClawHub } = await import("@openclaw-src/plugins/clawhub.js");
    const result = await withTimeout(
