...
import { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES } from "@openclaw-src/utils/message-channel.js";
  ...
  const resolvedPluginState = shouldResolveInstallablePlugin
    ? await (async () => {
        const { resolveInstallableChannelPlugin } =
          await import("@openclaw-src/channel-setup/channel-plugin-resolution.js");
