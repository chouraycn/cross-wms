...
} from "@openclaw-src/channels/plugins/types.adapters.js";
...
import { getChannelsCommandSecretTargetIds } from "@openclaw-src/cli/command-secret-targets.js";
import { formatUnsupportedChannelActionMessage } from "@openclaw-src/cli/error-format.js";
import { getRuntimeConfig, readConfigFileSnapshot } from "@openclaw-src/config/config.js";
import { danger } from "@openclaw-src/globals.js";
import { resolveMessageChannelSelection } from "@openclaw-src/infra/outbound/channel-selection.js";
import { type RuntimeEnv, writeRuntimeJson } from "@openclaw-src/runtime.js";
import { resolveInstallableChannelPlugin } from "@openclaw-src/channel-setup/channel-plugin-resolution.js";
