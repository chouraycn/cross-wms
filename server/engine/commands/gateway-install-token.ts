...
import type { ConfigWriteOptions } from "@openclaw-src/config/io.js";
import type { OpenClawConfig } from "@openclaw-src/config/types.js";
import type { ConfigFileSnapshot } from "@openclaw-src/config/types.openclaw.js";
import { resolveSecretInputRef } from "@openclaw-src/config/types.secrets.js";
import { shouldRequireGatewayTokenForInstall } from "@openclaw-src/gateway/auth-install-policy.js";
import { hasAmbiguousGatewayAuthModeConfig } from "@openclaw-src/gateway/auth-mode-policy.js";
...
} from "@openclaw-src/shared/gateway-tailscale-auth-policy.js";
import {
