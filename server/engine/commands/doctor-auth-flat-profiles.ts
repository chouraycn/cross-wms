...
import { resolveAgentDir, resolveDefaultAgentDir, listAgentIds } from "@openclaw-src/agents/agent-scope.js";
import { AUTH_STORE_VERSION } from "@openclaw-src/agents/auth-profiles/constants.js";
import {
  resolveAuthStatePath,
  resolveAuthStorePath,
  resolveLegacyAuthStorePath,
} from "@openclaw-src/agents/auth-profiles/paths.js";
import {
  applyLegacyAuthStore,
  coercePersistedAuthProfileStore,
  loadLegacyAuthProfileStore,
  loadPersistedAuthProfileStore,
} from "@openclaw-src/agents/auth-profiles/persisted.js";
import { coerceAuthProfileState } from "@openclaw-src/agents/auth-profiles/state.js";
import {
  clearRuntimeAuthProfileStoreSnapshots,
  saveAuthProfileStore,
} from "@openclaw-src/agents/auth-profiles/store.js";
import type {
  AuthProfileCredential,
  AuthProfileState,
  AuthProfileStore,
} from "@openclaw-src/agents/auth-profiles/types.js";
...
import type { AuthProfileConfig } from "@openclaw-src/config/types.auth.js";
import type { OpenClawConfig } from "@openclaw-src/config/types.openclaw.js";
import { coerceSecretRef } from "@openclaw-src/config/types.secrets.js";
