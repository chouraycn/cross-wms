...
import type { AgentIdentityFile } from "@openclaw-src/agents/identity-file.js";
import { identityHasValues, loadAgentIdentityFromWorkspace } from "@openclaw-src/agents/identity-file.js";
import { listRouteBindings } from "@openclaw-src/config/bindings.js";
import type { IdentityConfig } from "@openclaw-src/config/types.base.js";
