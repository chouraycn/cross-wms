...
} from "@cdf-know/gateway-protocol/index.js";
import { getRuntimeConfig } from "../config/config.js";
import { assertExplicitGatewayAuthModeWhenBothConfigured } from "../engine/gateway/auth-mode-policy.js";
import { resolveGatewayInteractiveSurfaceAuth } from "../engine/gateway/auth-surface-resolution.js";
import {
  buildGatewayConnectionDetails,
  ensureExplicitGatewayAuth,
  resolveExplicitGatewayAuth,
} from "../engine/gateway/call.js";
import { startGatewayClientWhenEventLoopReady } from "../engine/gateway/client-start-readiness.js";
import { GatewayClient, GatewayClientRequestError } from "../engine/gateway/client.js";
import { isLoopbackHost } from "../engine/gateway/net.js";
import { formatErrorMessage } from "../engine/infra/errors.js";
...
function throwGatewayAuthResolutionError(reason: string): never {
  throw new Error(
    [
      reason,
      "Fix: set CDFKNOW_GATEWAY_TOKEN/CDFKNOW_GATEWAY_PASSWORD, pass --token/--password,",
...
export class GatewayChatClient implements TuiBackend {
  ...
  constructor(connection: ResolvedGatewayConnection) {
    ...
    this.client = new GatewayClient({
      ...
      clientDisplayName: "cdf-know-tui",
