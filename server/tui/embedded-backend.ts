...
import type { SessionsPatchResult } from "@cdf-know/gateway-protocol/index.js";
import { agentCommandFromIngress } from "../engine/agents/agent-command.js";
import {
  resolveAgentDir,
...
import { ensureContextWindowCacheLoaded } from "../engine/agents/context.js";
import { DEFAULT_PROVIDER } from "../engine/agents/defaults.js";
import {
  buildAllowedModelSet,
  buildConfiguredModelCatalog,
  resolveThinkingDefault,
} from "../engine/agents/model-selection.js";
import { ensureRuntimePluginsLoaded } from "../engine/agents/runtime-plugins.js";
import { parseGoalCommand } from "../engine/auto-reply/reply/commands-goal.js";
...
import type { CrossWmsConfig } from "../config/schema.js";
import { isChatStopCommandText } from "../engine/gateway/chat-abort.js";
import {
  projectRecentChatDisplayMessages,
  resolveEffectiveChatHistoryMaxChars,
} from "../engine/gateway/chat-display-projection.js";
import { augmentChatHistoryWithCliSessionImports } from "../engine/gateway/cli-session-history.js";
import {
  normalizeLiveAssistantEventText,
  projectLiveAssistantBufferedText,
  resolveMergedAssistantText,
  shouldSuppressAssistantEventForLiveChat,
} from "../engine/gateway/live-chat-projector.js";
import { getMaxChatHistoryMessagesBytes } from "../engine/gateway/server-constants.js";
import {
  augmentChatHistoryWithCanvasBlocks,
  CHAT_HISTORY_MAX_SINGLE_MESSAGE_BYTES,
  enforceChatHistoryFinalBudget,
  replaceOversizedChatHistoryMessages,
} from "../engine/gateway/server-methods/chat.js";
import { loadGatewayModelCatalog } from "../engine/gateway/server-model-catalog.js";
import { performGatewaySessionReset } from "../engine/gateway/session-reset-service.js";
import {
  capArrayByJsonBytes,
  readSessionMessagesAsync,
} from "../engine/gateway/session-transcript-readers.js";
import {
...
} from "../engine/gateway/session-utils.js";
import { projectSessionsPatchEntry } from "../engine/gateway/sessions-patch.js";
import { type AgentEventPayload, onAgentEvent } from "../engine/infra/agent-events.js";
import { setEmbeddedMode } from "../engine/infra/embedded-mode.js";
import { logInfo, logWarn } from "../logger.js";
import { normalizeAgentId } from "../engine/session-key.js";
...
function hasProviderWildcardModelAllowlist(cfg: CrossWmsConfig) {
  const modelMaps = [
...
function resolveConfiguredReplaceModeCatalog(cfg: CrossWmsConfig) {
...
function shouldLoadFullGatewayCatalogForReplaceMode(cfg: CrossWmsConfig) {
...
async function loadEmbeddedTuiModelCatalog(cfg: CrossWmsConfig) {
...
export class EmbeddedTuiBackend implements TuiBackend {
  ...
  private async runBtwTurn(params: {
    ...
    const { runBtwSideQuestion } = await import("../engine/agents/btw.js");
      ...
      const result = await agentCommandFromIngress(
        {
          ...
          // bytes on the wire. See: https://github.com/cdf-know/cross-wms/issues/3658
