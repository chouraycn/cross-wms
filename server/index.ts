...
app.use('/api/wms/transfer-draft', lazyRouter(() => import('./routes/wms-transfer.js'), undefined, 'wms-transfer'));
...
app.use(`${API_PREFIX}/wms/transfer-draft`, lazyRouter(() => import('./routes/wms-transfer.js'), undefined, 'wms-transfer'));
