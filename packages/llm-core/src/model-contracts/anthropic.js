...
export function resolveClaudeModelIdentity(ref) {
    const configuredCanonicalModelId = typeof ref.params?.canonicalModelId === "string" ? ref.params.canonicalModelId : undefined;
...
export function resolveClaudeFable5ModelIdentity(ref) {
...
export function supportsClaudeAdaptiveThinking(ref) {
...
export function supportsClaudeNativeMaxEffort(ref) {
    const modelId = resolveClaudeModelIdentity(ref);
...
export function supportsClaudeNativeXhighEffort(ref) {
    const modelId = resolveClaudeModelIdentity(ref);
 ...
 */
export function resolveClaudeNativeThinkingLevelMap(ref) {
