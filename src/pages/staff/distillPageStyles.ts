// NOTE: 临时 stub — 从 StaffDeck 移植的蒸馏页面样式常量（完整版）。
// 仅替换了 `@/lib/utils` 别名为相对路径，其余与原版一致。
import { cn } from '../../components/staff/ui/utils';
...
export const FLOW_RULE_ITEM_CLASS =
  'grid min-w-0 max-w-full gap-x-[12px] gap-y-[10px] rounded-[12px] border border-[#eceef1] bg-[#fafafa] p-[12px]';
...
export const FLOW_RULE_FIELD_CONDITION_CLASS = '[grid-area:condition]';
