...
/**
 * Tailwind class tokens for the chat conversation page.
 *
 * Palette + metrics are derived from the SD1 Figma: background #fcfcfc, 220px
 * sidebar with a #f4f4f4 right border, ink #18181a, muted #858b9c / #757f9c,
 * hairline borders #e3e7f1 (0.5px), user bubble #f6f6f6, 56px header, and a
 * white composer card with a #18181a 0.5px border, 14px radius and a dark send
 * button.
 */
