import type { AgentProfileRead, AgentResourceBindingRead, AgentResourceType } from './types/index.js'
import {
  isEmployeeOwnedBy,
  isEnterpriseAdmin,
  isGalleryEmployee,
...
export function isAdmin(user?: EnterpriseAuthUser | null): boolean {
...
export function getEmployeeDisplayName(agent?: AgentProfileRead | null): string {
  return employeeDisplayName(agent)
}
