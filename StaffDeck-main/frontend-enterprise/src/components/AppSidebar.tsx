...
const SIDEBAR_SHELL_CLASS =
  'overflow-hidden bg-sidebar backdrop-blur-[9.5px] **:data-[slot=sidebar-inner]:bg-sidebar';
  ...
  return (
    <SidebarMenuItem>
      <SidebarMenuButton
        ...
        className={cn(
          'h-[40px] gap-[10px] rounded-[6px] px-[20px] py-[10px] text-[13px] text-sidebar-foreground',
          'hover:bg-sidebar-accent hover:text-sidebar-accent-foreground',
          'data-active:bg-[#FFFFFF] data-active:text-sidebar-accent-foreground data-active:font-normal',
  ...
  return (
    <SidebarMenuItem>
      <SidebarMenuButton
        ...
        onClick={() => onNavigate(item.route)}
        className={cn(
          'h-[36px] gap-[8px] rounded-[6px] px-[12px] py-[4px] text-[13px] text-sidebar-foreground',
          'hover:bg-sidebar-accent hover:text-sidebar-accent-foreground',
          'data-active:bg-[#FFFFFF] data-active:text-sidebar-accent-foreground data-active:font-normal',
          'group-data-[collapsible=icon]:px-0!',
        )}
      ...
      <TooltipTrigger asChild>
        <button
          ...
          className={cn(
            ...
            'hover:bg-sidebar-accent hover:text-sidebar-accent-foreground',
            active && 'bg-[#FFFFFF] text-sidebar-accent-foreground',
